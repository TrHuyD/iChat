...
{
    public class SkipListSortedSet<T> where T : IComparable<T>
    {
        private class Node
        {
            public T Value;
        ...
        public SkipListSortedSet(int maxLevel = 16)
        {
            _maxLevel = maxLevel;
            _rand = new Random();
        ...
        //            var newNode = new Node(item, lvl);
        //            for (int i = 0; i < lvl; i++)
        //            {
        //                newNode.Forwards[i] = update[i].Forwards[i];
        //                update[i].Forwards[i] = newNode;

        //                newNode.Spans[i] = update[i].Spans[i];
        //                update[i].Spans[i] = 1;
        //                update[i] = newNode;
        //            }
