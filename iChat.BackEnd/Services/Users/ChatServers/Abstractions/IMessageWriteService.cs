...
namespace iChat.BackEnd.Services.Users.ChatServers.Abstractions
{
    ...
    {
        Task<OperationResultT<NewMessage>> SendTextMessageAsync(MessageRequest request,string ServerId,bool fromApi);
        ...
        Task<OperationResultT<NewMessage>> SendMediaMessageAsync(MessageUploadRequest rq, string UserId,bool fromApi);
    }
}
